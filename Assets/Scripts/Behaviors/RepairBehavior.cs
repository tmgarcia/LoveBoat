    ...
    protected override void OnActionStart()
    {
        ...
        if (currentRepair == 0)
        {
            ...
            options = new List<DialogueOption>() {
                new DialogueOption("You look like you’ve seen better days.", () => { SetDialogue(new Dialogue(RepairMilestone1_OptionA(), null)); }),
                new DialogueOption("Change the subject", () => { SetDialogue(new Dialogue(RepairMilestone1_OptionB(), null)); }),
            };
        }
        ...
        else if (currentRepair < 60 && currentRepair + repairs >= 60)
        {
            ...
            options = new List<DialogueOption>() {
                new DialogueOption("Hornbeck was a terrible captain", () => { SetDialogue(new Dialogue(RepairMilestone4_OptionA(), null)); }),
                new DialogueOption("Hornbeck had to save herself", () => { SetDialogue(new Dialogue(RepairMilestone4_OptionB(), null)); }),
            };
        }
        else if (currentRepair < 80 && currentRepair + repairs >= 80)
        {
            ...
            options = new List<DialogueOption>() {
                new DialogueOption("Probably", () => { SetDialogue(new Dialogue(RepairMilestone5_OptionA(), null)); }),
                new DialogueOption("Probably not", () => { SetDialogue(new Dialogue(RepairMilestone5_OptionB(), null)); }),
                new DialogueOption("Who cares?", () => { SetDialogue(new Dialogue(RepairMilestone5_OptionC(), null)); }),
            };
        }
        else
        {
        ...
        SetDialogue(new Dialogue(lines, options));
    }
